...
hmmer_vis.pdb_viewer = function() {
	...
	// The cbak returned
	var pdb_viewer = function(div_id, pdb_id) {
       ...
       var structure;
		...
		document.getElementById(div_id).innerHTML = 'loading '+pdb_id;
        var xhr = new XMLHttpRequest();
        //xhr.open('GET', 'http://www.ebi.ac.uk/pdbe/entry-files/download/pdb/'+pdb_id+'.ent');
		xhr.open('GET', '../../data/'+pdb_id+'.pdb');
