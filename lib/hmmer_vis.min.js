"use strict";
var hmmer_vis = {};
hmmer_vis.dispatch = d3.dispatch('update', 'search_tableSpecies', 'update_histogram','search_tableRange', 'update_lineage_plot','update_tree_legend');
...
hmmer_vis.domain_architectures_view = function() {
	...
	var domain_architectures_view = function(div, data) {
		...
		var example_text = middle_div.append("div").attr('class','query_div')
...
var Info = {
	...
	jarPath: "../../../lib/jsmol/java",// this needs to point to where the java directory is.
	jarFile: "JmolAppletSigned.jar",
	isSigned: true,
	script: "set antialiasDisplay;load ../../../data/jsmol/caffeine.mol",
...
$("#chart").html(Jmol.getAppletHtml("jmolApplet0", Info))
